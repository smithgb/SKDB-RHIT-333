						...
						<ul class="nav navbar-nav">
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="/rootSKDB/azlist.php">A-Z List</a>
									</li>
									<li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					...
					echo "<h4>Location of Murder: " . $location['City'] . ', ' . $location['State'] . ', ' . $location['Country'] . "</h3>";

					echo "<h3>Cause of Death: " . $row['CauseOfDeath'] . "</h3>";

					echo "<h4>Relation to Killer: " . $row['RelationToKiller'] . "</h4>";
					?>
				</div>
			</div>
		</div>
